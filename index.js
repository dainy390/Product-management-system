...
app.use(setLastVisit);  // set last visit added 
app.use(session(
  {
    secret:'SecretKey',
    resave:false,
...
app.post('/',auth,
  uploadFile.single('imageUrl'), // single mean data will be return which is associated with form field
  validationMiddleware,productsController.postAddProduct
);
